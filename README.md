...
A boring, tiny tool for reading GitHub issue threads from the terminal.
...
Simon Willison's habit of narrating his work into a GitHub issue is a fix
...
This is the first of a few small tools trying to carry ideas from Roam into
